...
def extract_control_points(clean_ecg_sig, sampling_rate = 1000):
    """
    ...
    waves, signals = nk.ecg_delineate(clean_ecg_sig, rpeaks_cleaned, sampling_rate=sampling_rate)
    
    return signals, rpeaks_cleaned, waves
